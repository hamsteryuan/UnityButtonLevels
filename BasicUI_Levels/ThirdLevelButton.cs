...
//有关于第三层元素的颜色与选中控制
//注意，任何函数请前往SecondListner
public class ThirdLevelButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    private ThirdLevelButton[] allButtons; // 所有按钮的引用
    ...
    void Awake()
    {
        ...
        allButtons = FindObjectsOfType<ThirdLevelButton>();
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        foreach (ThirdLevelButton button in allButtons)
        {
