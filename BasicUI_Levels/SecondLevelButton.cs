...
public class SecondLevelButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    private SecondLevelButton[] allButtons; // 所有按钮的引用
    ...
    void Awake()
    {
        ...
        allButtons = FindObjectsOfType<SecondLevelButton>();
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        foreach (SecondLevelButton button in allButtons)
        {
